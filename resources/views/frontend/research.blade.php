        ...
        <div id="main-content" class="single-page-content">
            <div id="primary" class="content-area">
                ...
                <div class="page-title">
                    <h1>Research
                        <a target="_blank" href="https://scholar.google.com/citations?user=E6D5JZQAAAAJ&hl=en">
                        ...
                        <a target="_blank" href="https://www.researchgate.net/profile/Mahedi-Hasan-34/research"><i
                                style="color: #0cb" class="fa-brands fa-researchgate"></i></a>
                        <a target="_blank" href="https://orcid.org/0000-0002-3263-4636"><i style="color: #A6CE39"
                ...
                <div id="content" class="page-content site-content single-post" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            ...
                            @php echo $settings['conference']; @endphp
                        </div>
                    </div>
...
{{--                    <div class=" col-xs-12 col-sm-6 ">
                    ...
                    <div class="row">
                        <div class=" col-md-12 ">
                            ...
                            <div class="clearfix ">
                                @php echo $settings['awards']; @endphp
                            </div>
                        </div>
                    </div>

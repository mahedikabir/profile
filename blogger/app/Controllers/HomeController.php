...
class HomeController extends BaseController
{
    ...
    private function post($slug)
    {
        ...
        if (empty($data['post'])) {
            ...
            if (!authCheck() && $data['post']->need_auth == 1) {
                ...
                return redirect()->to(langBaseUrl('login'));
            }
    ...
    public function addCommentPost()
    {
        ...
        if ($this->generalSettings->comment_approval_system == 1) {
            ...
            $dataJson = [
                'type' => 'comments',
                'message' => view('post/_comments', $data, true)
            ];
    ...
    public function closeNewsletterPopup()
    {
        setCookie('inf_news_p', 1);
    }
    ...
    {
        setCookie('inf_cookies_warning', '1');
    }
}

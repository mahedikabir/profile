...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/admin/css/custom-4.1.css'); ?>">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <?php if (isAdmin()): ?>
                    ...
                    <li class="treeview<?= isAdminNavActive(['add-page', 'pages', 'update-page']); ?>">
                        <a href="#">
                            <i class="fa fa-leaf"></i> <span><?= trans("pages"); ?></span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                        </a>
                        <ul class="treeview-menu">
                            <li class="nav-add-page">
                                <a href="<?= adminUrl('add-page'); ?>"><?= trans("add_page"); ?></a>
                            </li>
                            <li class="nav-pages">
                                <a href="<?= adminUrl('pages'); ?>"><?= trans("pages"); ?></a>
                            </li>
                        </ul>
                    </li>
                <?php endif; ?>
                ...
                <?php if (isAdmin()): ?>
                    ...
                    <li class="treeview<?= isAdminNavActive(['add-poll', 'polls', 'update-poll']); ?>">
                        <a href="#">
                            <i class="fa fa-list"></i> <span><?= trans("polls"); ?></span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                        </a>
                        <ul class="treeview-menu">
                            <li class="nav-add-poll">
                                <a href="<?= adminUrl('add-poll'); ?>"><?= trans("add_poll"); ?></a>
                            </li>
                            <li class="nav-polls">
                                <a href="<?= adminUrl('polls'); ?>"><?= trans("polls"); ?></a>
                            </li>
                        </ul>
                    </li>

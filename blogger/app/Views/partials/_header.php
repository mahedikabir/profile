...
<?php endif; ?>
    ...
    <?= !empty($siteFonts->primary_font_url) ? $siteFonts->primary_font_url : ''; ?>
    <?= !empty($siteFonts->secondary_font_url) ? $siteFonts->secondary_font_url : ''; ?>
    ...
    <link href="<?= base_url('assets/css/style-4.1.1.min.css'); ?>" rel="stylesheet"/>
<?php if ($darkMode == 1) : ?>
    <link href="<?= base_url('assets/css/dark-4.1.min.css'); ?>" rel="stylesheet"/>
<?php endif;
if ($activeLang->text_direction == "rtl"): ?>
    <script>var rtl = true;</script>
    <link href="<?= base_url('assets/css/rtl-4.1.min.css'); ?>" rel="stylesheet"/>
<?php else: ?>
